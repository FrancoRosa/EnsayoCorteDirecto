...
win.setWindowTitle('Corte directo para suelos gravosos')
...
softlabel = QtGui.QLabel('<div style="text-align: center;"><span style="color: #FFF; font-size: 14pt;">Corte directo para suelos gravosos</span></div>')
